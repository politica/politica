<div class="bg-gray-900 rounded-lg">
    <div class="p-6 flex space-x-8 items-center">
        <a href="{{ route('users.show', ['user' => user()]) }}" class="flex-shrink-0">
            <img src="{{ user()->avatar }}" onError="this.onerror = null; this.src = '/images/user.png';"
                 class="w-16 h-16 rounded-full"
            />
        </a>
        <div class="flex-grow flex items-center justify-between">
            <h4 class="font-medium text-lg">You haven't taken this test yet</h4>
