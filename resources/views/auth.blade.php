    ...
    <div class="mt-6 space-y-3 sm:space-x-3 sm:space-y-0 text-center">
        <span class="rounded-md shadow-sm inline-flex">
            <button wire:click="redirectToProvider('discord')" type="button"
                    class="inline-flex items-center px-6 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-gray-700 border border-transparent rounded-md hover:bg-gray-700 focus:outline-none focus:border-gray-600 focus:shadow-outline-gray active:bg-gray-700"
            >
